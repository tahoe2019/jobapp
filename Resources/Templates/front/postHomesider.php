...
<div class="max-w-3xl mx-auto">
   ...
   <div class="py-4">
       ...
       <h1 class="text-3xl font-bold mb-1">tahoe yare ?></h1>
       <p class="text-black-500 text-sm">Published on <time datetime="2022-04-05">April 5, 2022</time></p>
   </div>

   <!-- Featured image -->
   <img class="rounded-lg" src="" alt="Featured image" class="w-full h-auto mb-8">
   ...
   <div class="prose prose-sm sm:prose lg:prose-lg xl:prose-xl mx-auto">
       ...
       <p>Integer ullamcorper leo nulla, nec commodo metus vehicula eget. Duis vel vestibulum tellus, eget mattis
           ...
           <button class="rounded-full ...">Apply now</button>
   </div>
 </div>
</div>
